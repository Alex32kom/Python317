...
# #         s += i
#
# print("Колличество чётных элементов списка: ", count)
# print("Колличество нечётных элементов списка: ", s)

# n = [4, 9, 6]  # list(range(21, 41))
# print(n)
# i = 0
# print(n[i])
# print(n[i - 1])
...
#
# s= "Hello World!"
# print(list(s[6:11]))  #[6:-1]

# s = list(range(1,8))
# print(s)
# print(s[::-1])
# print(s[::2])  #[7 6 5 4 3 2 1 ]
# print(s[1::2])
# print(s[0:1])
# print(s[-1:])  #7
# print(s[3:4])   #4
...
# dir(list)  - консоль console
# s = [9, 3, 7, 8, 4, 6, 5]
# print(s)
# # s[len(s):] = [12]
# s.append(12)  #Добавляет один элмент в конец списка ( любого типа данных!!!!)
# print(s)
# s.extend([1,2,3])  #Долбавляет множество элементов в конец списка
# print(s)
# s.extend("add")
# print(s)
# s.insert(0,'hello') # Добавляем в список в заданный индекс(первый параметр), значение( второй параметр)
# print(s)
# s.insert(20,90)  #Указываем индекс. которого не существует , но который точно больше всего списка!!!
# print(s)
#
# a = [int(input("->")) for i in range(int(input("n = ")))]
# print(a)
